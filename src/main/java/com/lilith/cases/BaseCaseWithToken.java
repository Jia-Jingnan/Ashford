...
/**
 * @Author:JiaJingnan
 * @Date: 下午10:03 2021/5/20
 */
@Slf4j
public class BaseCaseWithToken {

    @Test(dataProvider = "datas")
    public void test(String caseId, String apiId, String parameter, String expectedResponseData, String token){
        ...
        log.info("开始调用接口");
        String response = HttpUtil.doService(type,url,params,tokenParam,token);
